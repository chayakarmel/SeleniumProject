te GoogleResultsPage googleResultsPage;
        public static IEnumerable<TestData> TestCases => XmlDataReader.ReadTestData("T:\\הנדסת תוכנה\\שנה ב\\קבוצה א\\פיתוח אוטומציה\\שיעור4\\SeleniumProject\\SeleniumProject\\TestData.xml");


        [OneTimeSetUp]using NUnit.Framework.Interfaces;
...
namespace SeleniumProject
{
    ...
    public class GoogleSearchTest
    {
        ...
        public void SetUp()
        {
            string path = "T:\\הנדסת תוכנה\\שנה ב\\קבוצה א\\פיתוח אוטומציה\\שיעור4\\SeleniumProject\\SeleniumProject";
